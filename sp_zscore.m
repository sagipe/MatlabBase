function [z,mu,sigma] = sp_zscore(x,flag,dim)
% This version implements ZSCORE ignoring NaN values
...
%   $Revision: 1.1 $  $Date: 2010-10-13 21:15:05 $
...
sigma0 = sigma;
sigma0(sigma0>(-1e-8) & sigma0<1e-8) = 1;
z = bsxfun(@minus,x, mu);
